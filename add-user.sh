...
# Description: The script is used add a virtual user for email server. Before adding new user it will check the username/email address already exists or not.
#
